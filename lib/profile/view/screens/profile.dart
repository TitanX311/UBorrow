...
import 'package:uborrow/core/providers/user_provider.dart';
            ...
            children: [
              ...
              CircleAvatar(
                ...
                child: user.maybeWhen(
                  data: (u) => u.photoURL == null
                      ? const Icon(Icons.person, size: 45)
                      : null,
                  orElse: () => const Icon(Icons.person, size: 45),
                ),
              ),
              const SizedBox(height: 15),
              Text(
                user.maybeWhen(
                  data: (user) => user.name ?? "Loading...",
                  orElse: () => "Loading...",
                ),
